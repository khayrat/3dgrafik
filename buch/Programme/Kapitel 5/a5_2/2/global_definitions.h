...
const long largest_vertex_count = 500;
vertex wpoint[ largest_vertex_count+10 ];
vertex c_wpoint[ largest_vertex_count+10 ];
svertex spoint[ largest_vertex_count+20 ];
svertex c_spoint[ largest_vertex_count+20 ];

const long largest_point_count = 10;
