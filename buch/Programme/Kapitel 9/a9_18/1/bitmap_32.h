...
class bitmap_32
{
  public:
    ...
    void display( long sx, long sy, pixel_32 c, pixel_32 tr, pixel_32 *sbuffer );
...
void bitmap_32::display( long sx, long sy, pixel_32 c, pixel_32 tr, pixel_32 *sbuffer )
{
  long x, y, z;
  ...
  for( y=0, z=0 ; y<yscale ; y++ )
  {
    for( x=0 ; x<xscale ; x++ )
    {
      if( picture[ z ] != tr ) sbuffer[ offset ] = c;
