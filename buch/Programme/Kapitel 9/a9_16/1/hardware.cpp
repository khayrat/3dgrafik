...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int iCmdShow )
{
  ...
  viewport user;  length = user.load( x_res, y_res, pr_cnst, z_min, 200 );
  landscape planet;  height = planet.load( 700, length );
  ...
  while( 1 )
  {
    ...
    {
      m.clear();
      m.columns( planet_ls.x_axis, planet_ls.y_axis, planet_ls.z_axis );
      m.translate( planet_ls.pos.wx, planet_ls.pos.wy, planet_ls.pos.wz );
      m.adjust_hardware(); 
