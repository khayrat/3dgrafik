...
int APIENTRY WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int iCmdShow )
{
  ...
  virtual_keys[ 4 ].load( 555, 433, "dec_up.bmp", "dec_down.bmp", "dec_selected.bmp", decrease_yellow_radius, 0 );
  virtual_keys[ 5 ].load( 690, 433, "inc_up.bmp", "inc_down.bmp", "inc_selected.bmp", increase_yellow_radius, 0 );
