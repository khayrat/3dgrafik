...
uchar handle_input( polyhedron *p )
{
  ...
  if( input.key_pressed( 'R' ) ) m.rotate_x(  0.04 );
  if( input.key_pressed( 'F' ) ) m.rotate_x( -0.04 );
  if( input.key_pressed( 'D' ) ) m.rotate_y(  0.04 );
  if( input.key_pressed( 'G' ) ) m.rotate_y( -0.04 );
  if( input.key_pressed( 'E' ) ) m.rotate_z(  0.04 );
  if( input.key_pressed( 'T' ) ) m.rotate_z( -0.04 );

  m.translate( p->pos.wx, p->pos.wy, p->pos.wz );

  if( input.key_pressed( 'H' ) ) m.translate( -10,   0,   0 );
  if( input.key_pressed( 'K' ) ) m.translate(  10,   0,   0 );
  if( input.key_pressed( 'Z' ) ) m.translate(  0,  -10,   0 );
  if( input.key_pressed( 'I' ) ) m.translate(  0,   10,   0 );
  if( input.key_pressed( 'J' ) ) m.translate(  0,    0, -10 );
  if( input.key_pressed( 'U' ) ) m.translate(  0,    0,  10 );
