...
class polygon
{
  private:
    ...
    void rasterize( bitmap_32 *surface, pixel_32 *sbuffer );

  public:
    void load( long a, long b, long c, long d );
    void update_pos( matrix m ) {  normal = m * normal;  }
    void display( vertex *vs, bitmap_32 *surface, pixel_32 *sbuffer );
...
void polygon::display( vertex *vs, bitmap_32 *surface, pixel_32 *sbuffer )
{
...
void polygon::rasterize( bitmap_32 *surface, pixel_32 *sbuffer )
{
...
void polygon::load( long a, long b, long c, long d )
{
  point_count = 4;
