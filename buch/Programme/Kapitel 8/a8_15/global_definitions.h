...
tvertex wpoint[ largest_point_count+10 ], c_wpoint[ largest_point_count+10 ];
svertex spoint[ largest_point_count+20 ], c_spoint[ largest_point_count+20 ];
...
const double max_clear_translation = 86400;

vector light( -1, -1, 1 );

primary_bitmap adv_surface( 64, "metal.bmp", 0.2 );
